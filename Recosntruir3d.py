...
print('Adaptado por: Victor Hugo Zani '.center(58))
print('NºUSP: 13861259'.center(58))
print('Created on 05/05/2020 - Last update on 03/11/2023'.center(58))
print(58*'#')
print('\n')
...
# Mudar o diretório
#new_directory = r"C:/Users/Victor Hugo Zani/OneDrive/Documentos/usp/biomec_trab2"
...
def rec3d_ide(c1=None, c2=None, ref=None):
    # Para teste na IDE
    if c1 is None:
        c1 = pd.read_csv('c1cal2rec3d.dat', delimiter=' ', header=None)    
        c2 = pd.read_csv('c2cal2rec3d.dat', delimiter=' ', header=None)
        dfcp3d = pd.read_csv('ref3d_v2.ref', delimiter=' ',header=None)
    else:
        dfcp2d_c1 = c1
        dfcp2d_c2 = c2
        dfcp3d = ref
...
if __name__ == '__main__':
    cp2d_c1 = pd.read_csv('c1cal2rec3d.dat', delimiter=' ', header=None)    
    cp2d_c2 = pd.read_csv('c2cal2rec3d.dat', delimiter=' ', header=None)
    cp2dc1 = np.asarray(cp2d_c1)
    cp2dc2 = np.asarray(cp2d_c2)
    
    cp3d =pd.read_csv('ref3d_v2.ref', delimiter=' ',header=None)
    cp3d = np.asarray(cp3d) 
...
# Carregando os pontos reconstruídos a partir do arquivo de saída
cc3d = np.loadtxt("cordfinal.3d")

# Exibir os pontos 3D reconstruídos
fig = plt.figure()
